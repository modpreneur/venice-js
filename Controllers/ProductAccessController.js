...
var ProductAccessController = function (_Controller) {
    ...
    function ProductAccessController() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(ProductAccessController).apply(this, arguments));
    }
    ...
    _createClass(ProductAccessController, [{
        ...
        value: function newAction($scope) {
            //Attach VeniceForm
            $scope.form = new _VeniceForm2.default(q('form[name="product_access"]'), _VeniceForm2.default.formType.NEW);
        }
    }, {
        key: 'tabsAction',
...
exports.default = ProductAccessController;